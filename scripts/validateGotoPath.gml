...
check = collision_line(argument0,argument1,argument2,argument3,obj_wall,false,true);
...
check0 = collision_line(side0x,side0y,otherSide0x,otherSide0y,obj_wall,false,true);
check1 = collision_line(side1x,side1y,otherSide1x,otherSide1y,obj_wall,false,true);
